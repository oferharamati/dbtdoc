  ...
  create or replace   view OFER_DB.dbt_MID.mid_signups
   ...
   as (
    select  v.uuid_ts,
        ...
        u.goal, 
        u.is_work
from    OFER_DB.dbt_MID.mid_visitors v, 
        OFER_DB.dbt_DS.stg_web_identifies i, 
        OFER_DB.dbt_DS.stg_web_users u 
